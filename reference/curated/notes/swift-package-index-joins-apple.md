...
Самая интересная часть — в том, что они прямо называют будущие направления: discovery, security, reliability, package signing и identity. То есть Swift Package Index постепенно может стать не просто поиском по пакетам, а более официальным слоем доверия вокруг Swift-зависимостей. Если ты не использовал SPI до этого, но используешь Swift Package — самое время проверить:

🟢 какие SPM-зависимости у тебя живут в проектах  
...
🟢 сможешь ли ты быстро заменить её, если пакет заброшен или сломается на новом SDK  

SPI уже сейчас помогает отвечать на эти вопросы.
