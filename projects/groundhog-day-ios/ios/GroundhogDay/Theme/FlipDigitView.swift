...
struct FlipDigitView: View {
    @Environment(\.flipTileMetrics) private var metrics
    ...
    init(digit: Int, shouldAnimate: Bool = false, reduceMotion: Bool) {
        self.digit = digit
