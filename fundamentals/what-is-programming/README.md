...
**Дальше:** [Почему нам нужен буквальный исполнитель?](../literal-executor/)
...
Когда пройдёшь главу — чекбоксы ниже для себя (необязательно). Агент не отмечает их за читателя.
