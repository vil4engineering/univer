...
| **Review** | [0001](../../reviews/0001-what-is-programming.md) · [0001b](../../reviews/0001b-what-is-programming.md) |
| **Confidence** | — /5 |
| **Assets** | Spine Mermaid live; I1–I8 still optional polish |
...
Компьютер почти никогда не делает «не то».

Он безошибочно делает **именно то, что вы ему сказали** — даже если вы хотели совсем другое.
...
Level 1: достаточно досюда. Код ниже — опционально.
...
Уточняющие вопросы к заказчику — уже инженерия. Ещё до первой строки Swift.
...
|------|--------|------------|-------|
| 2026-07-24 | learning | — | v1.1: cold open, axiom, Software/Hardware, spine, mental model, history; [0001b](../../reviews/0001b-what-is-programming.md) |
