...
- Home = org **vil4engineering** · flagship repo `engineering-university` · site `vil4engineering.github.io/engineering-university/`  
...
| Decision | Status |
|----------|--------|
| SE over framework tourism | Binding (v2) |
| Dual AI axes (tool + technology) | Binding (v2) |
| Completeness pyramid Understand→Teach | Binding |
| Decisions over dogma | Binding |
| Levels 1–3 on topics | Binding (v2) |
| Skills = agent-executable workflows | Binding (v2) |
| Career OS hybrid (private outside) | Binding (v2) |
| Progress = Evidence | Binding |
...
| Doc | Purpose |
|-----|---------|
| [01_CHARTER.md](01_CHARTER.md) | v2 constitution |
| [campus/ASSISTANT_MANUAL.md](campus/ASSISTANT_MANUAL.md) | How to use repo learning assistant |
