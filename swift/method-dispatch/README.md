...
| Стратегия | Когда решать | Типичный кейс | Грубая стоимость |
|-----------|--------------|---------------|------------------|
...
Оптимизации (`final`, Whole Module Optimization, известный конкретный тип) могут **devirtualize** vtable-вызов обратно в static. Поэтому «класс = всегда vtable» — упрощение для интервью, не железный закон.
