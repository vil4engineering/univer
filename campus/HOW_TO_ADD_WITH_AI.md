...
**Тимур, учёба с агентом (не только «добавить»):** [FOR_TIMUR.md](FOR_TIMUR.md).
...
5. **Чужая статья / большой внешний материал** → в note или `materials/` **сначала Выжимка**: анализ + несколько строк «о чём» и зачем на полке; тело — после. Без выжимки не класть.
