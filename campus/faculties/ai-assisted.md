# Faculty of AI-assisted Software Engineering (Track 1)

**How engineers use AI** — tool axis.

Topics: Cursor · Codex · Claude Code · Copilot · Coding Agents · Prompt Engineering · Engineering Workflows · Code Review · Architecture Review · ADR generation · Documentation · Automation · Agent Skills · Career OS craft (public only).
