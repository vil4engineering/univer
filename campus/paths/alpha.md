...
**Слой:** поверх [Foundations](beta.md).  
Это не альтернатива фундаменту и не «другой курс вместо Beta».

**Для кого:** уже пишешь код и хочешь системную глубину — архитектура, concurrency, quality, ownership.

**Как устроен обход:** Alpha идёт по графу знаний *вперёд*, но постоянно ссылается *вниз*:
